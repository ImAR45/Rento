                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li class="nav-item" style="position: absolute; right: 11%">
                                                ...
                                                <form action="index.php"  name="login" method="post">
                                                    <div class="login-box">
                                                        ...
                                                        <div class ="textbox">
                                                            ...
                                                            <input type = "text"  name="email" value="" style="border: calc;" >
                                                        </div>
                                                        <br>
                                                        <div class="textbox">
                                                        ...
                                                        <div class="modal-footer">
                                                            <input type="submit" name="login" class="btn btn-secondary" value="Login"></input>
                                                        </div>
                                        ...
                                        <form action="index.php" name="registration" method="post" >
                                            <div class="registration-box">
                                                ...
                                                <div class="textbox">
                                                    ...
                                                    <input type="text" placeholder="Email-Id" name="pemail" value="">
                                                </div>
                                                <div class="textbox">
                                                    <i class="fi-xwsuxl-envelope-solid"></i>
...
<div style="background: #5556; height: 700px; padding-top: 10%;" >
    <div class= "container" style="padding: 20px;">
        <div class = "row">
            ...
            <div class="col-md-7" >
                ...
                <br>
                <p class="price"> <?php echo $result['rent']?>/month</p>
                <p><b>Availability:</b>In Stock</p>
                <p><b>Condition:</b> <?php echo $result['cnd']?></p>
            ...
            <div>
                <textarea class="productText" disabled="true"> <?php echo $result['text']?></textarea>
            </div>
        </div>
    </div>
