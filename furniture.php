...
<div>
    <?php
    $getposts = mysqli_query($conn, "SELECT * FROM images WHERE type ='FU'  ORDER BY id DESC LIMIT 10") or die(mysqli_error($conn));
    if (mysqli_num_rows($getposts)) {
        ...
        while ($row = mysqli_fetch_assoc($getposts)) {
            ...
            echo '<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
							<ul style="float: left;">
